...
export class SignupPageComponent {
  ...
  constructor(private _fb: FormBuilder, private userService: UserManagementService) {}
  ...
  ngOnInit(): void {
    this.form = this._fb.group({
      ...
      confirmPassword: ['', Validators.compose([Validators.required, this.confirmPasswordValidator])] // Custom validator for matching passwords
    })
  }
